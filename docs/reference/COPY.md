...
## Structure (sections to be written in Session 3)

### Desktop window inventory
*Added here after Session 3 PART 1 — lists each window, its title bar text, and content purpose.*
...
*Additional sections added in Session 3.*
